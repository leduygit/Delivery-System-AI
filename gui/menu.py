...
class Menu:
    def __init__(self):
        ...
        self.lv1_button = pygame.image.load('Assets/images/menu/lv1.png')
        ...
        # Load hover images
        self.lv1_button_hover = pygame.image.load('Assets/images/menu/lv1-2.png')
        ...
        self.lv1_button_rect = self.lv1_button.get_rect(center=(WINDOW_SIZE[0] // 2, button_y))
    ...
    def draw(self, screen):
        ...
        if self.hovered_button == 'lv1':
            screen.blit(self.lv1_button_hover, self.lv1_button_rect.topleft)
        else:
            screen.blit(self.lv1_button, self.lv1_button_rect.topleft)
    ...
    def handle_events(self):
        ...
        if mouse_pos:
            if self.lv1_button_rect.collidepoint(mouse_pos):
                self.hovered_button = 'lv1'
